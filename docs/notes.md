Good repo
https://github.com/m-radzikowski/icons-asset-generator

console.log(
  Object.keys(mxStencilRegistry.stencils)
    .filter(k => k.startsWith('mxgraph.aws4'))
    .sort()
    .join('\n')
);

Export in Safari console using the command above when drawio is loaded in the browser.
